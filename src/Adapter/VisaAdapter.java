...
public class VisaAdapter extends BaseAdapter {
	...
	public VisaAdapter(Context context) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		if (arg1 == null) {
			arg1 = inflater.inflate(R.layout.visa_list_item,null);
			hodler = new ViewHodler();
			hodler.bank1 = (TextView) arg1.findViewById(R.id.visa_bank);
			hodler.bank2 = (TextView) arg1.findViewById(R.id.visa_card);
			hodler.user = (TextView) arg1.findViewById(R.id.visa_user);
			hodler.img = (ImageView) arg1.findViewById(R.id.visa_lable);
